...
<ol>
    ...
    <li>adjusts a USB transfer period of the USB HAL driver (not the recently common hardware offloading USB (tunneling) driver) for directly reducing the jitter of a PLL in a DAC (even in an asynchronous mode); Use ["USB_SampleRate_Changer"](https://github.com/yzyhk904/USB_SampleRate_Changer) to switch from the usual hardware offloading USB (tunneling) driver to the USB HAL one,</li>
